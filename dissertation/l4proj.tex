...
\textbf{<note on the importance of an end-to-end method - justify why we would want to reinvent the wheel badly>}
...
\item A software base allowing the integration of custom scoring functions, and allows the provision of custom mass tables/alphabets for the compounds being operated on.
...
\begin{figure}
    \centering
    \makebox[\linewidth][c]{\includegraphics[width=1.0\linewidth]{images/system_layout.png}}%

    \caption{An illustration of our proposed system layout. We write input on the top of arrows, and output on the bottom.
    }
...
\textbf{<note to include np-hardness of original problem in its most general form - I can reference the MS book for this>}
